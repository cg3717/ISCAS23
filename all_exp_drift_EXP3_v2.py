...
for exp_path in tqdm(experiments_pos, desc='Drift Exp'):
    ...
    if exp_type == 'ph8_8':
        ...
        print(F'EXP {exp_path_str}: ERROR. COULD NOT MATCH EXPERIMENT TYPE')
    ...
    # ADAPT COEFFICIENTS
    # TODO CONTROLLAAA
    # a1 = param_seg1[4, :]*(param_seg1[1, :]-param_seg1[0, :])+param_seg1[0, :]+param_seg1[2, :]*(param_seg1[1, :]-param_seg1[0, :])
    # b1 = param_seg1[4, :]*(param_seg1[1, :]-param_seg1[0, :])*np.exp(param_seg1[3, :]/param_seg1[5, :])
    # c1 = param_seg1[5, :]
    #
    # a2 = param_seg2[4, :]*(param_seg2[1, :]-param_seg2[0, :])+param_seg2[0, :]+param_seg2[2, :]*(param_seg2[1, :]-param_seg2[0, :])
    # b2 = param_seg2[4, :]*(param_seg2[1, :]-param_seg2[0, :])*np.exp(param_seg2[3, :]/param_seg2[5, :])
    # c2 = param_seg2[5, :]
    #
    # a3 = param_seg3[4, :]*(param_seg3[1, :]-param_seg3[0, :])+param_seg3[0, :]+param_seg3[2, :]*(param_seg3[1, :]-param_seg3[0, :])
    # b3 = param_seg3[4, :]*(param_seg3[1, :]-param_seg3[0, :])*np.exp(param_seg3[3, :]/param_seg3[5, :])
    # c3 = param_seg3[5, :]
   ...
   # print(np.exp(param_seg1[3, :]/param_seg1[5, :]))

    a2 = param_seg2[4, :]+param_seg2[2, :]
    b2 = param_seg2[4, :]*np.exp(param_seg2[3, :]/param_seg2[5, :])
    c2 = param_seg2[5, :]
   # print(np.exp(param_seg2[3, :]/param_seg2[5, :]))

    # FIND DELTAS
    if exp_type == 'ph8_8':
        delta1_a_999.append((a2-a1))  # todo add divistion
